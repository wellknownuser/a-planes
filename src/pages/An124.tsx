          ...
          <div className="history-content">
            ...
            <div className="timeline">
              ...
              <div className="timeline-item">
                <div className="timeline-year">1992</div>
                <div className="timeline-content">
                  <h3>Перевезення золота</h3>
                  <p>У травні 1992 року з Об’єднаних Арабських Еміратів до Швейцарії було доставлено 52 тонни золота на суму 230 мільйонів фунтів стерлінгів.</p>
                </div>
              </div>
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  <h3>Транспортування локомотива</h3>
                  <p>У січні 2001 року літак Ан-124 використали для транспортування 109-тонного локомотива з Канади до Ірландії.</p>
                </div>
              </div>
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  <h3>Оренда літаків союзом НАТО</h3>
                  <p>У березні 2006 року НАТО орендувало літаки Ан-124 для тимчасового вирішення проблеми нестачі стратегічних авіаперевезень у ЄС до початку постачання літаків Airbus A400M у 2010 році. За умовами контракту два Ан-124-100 були передані в постійний чартер, ще два — доступні за замовленням за шість днів, а решта два — із повідомленням за дев’ять днів.</p>
                </div>
              </div>
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  <h3>Перевезення важливих складових ракети</h3>
                  <p>У 2018 році вантажний Ан-124-100 «Руслан» авіакомпанії «Авіалінії Антонова» забезпечив перевезення головного обтічника найбільшої у світі ракети Falcon Heavy. Літак подолав 3 613 км за 4,5 години, доставивши важливу складову ракети для своєчасного запуску з космодрому на мисі Канаверал.</p>
                </div>
              </div>
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  <h3>Доставка супутника</h3>
                  <p>У грудні 2020 року було доставлено супутник із французької Тулузи на аеродром NASA у США.</p>
                </div>
              </div>
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  <h3>Транспортування деталей для ракет-носіїв</h3>
                  <p>Приватна американська аерокосмічна компанія SpaceX залучила український транспортний літак Ан-124 для оперативного транспортування компонентів, потрібних для запуску Falcon 9.</p>
                </div>
              </div>
            </div>
          </div>
