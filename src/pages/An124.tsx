        ...
        <div className="container">
          <div className="overview-grid">
            <div className="overview-content">
              <h2>Огляд</h2>
              <p>
                Антонов АН-124 Руслан (код НАТО: Кондор) — великий стратегічний чотиримоторний 
        ...
        <div className="container">
          ...
          <div className="specs-grid">
            <div className="spec-card card">
              <h3>Розміри</h3>
              <ul>
                <li><strong>Довжина:</strong> 69,1 м (226 футів 8 дюймів)</li>
                <li><strong>Розмах крил:</strong> 73,3 м (240 футів 6 дюймів)</li>
                <li><strong>Висота:</strong> 20,78 м (68 футів 2 дюйми)</li>
                <li><strong>Площа крила:</strong> 628 м² (6,760 кв. футів)</li>
              </ul>
            </div>
            ...
            <div className="spec-card card">
              ...
              <ul>
                <li><strong>Порожня вага:</strong> 175,000 кг (385,809 фунтів)</li>
                <li><strong>Макс. злітна вага:</strong> 405,000 кг (893,077 фунтів)</li>
                <li><strong>Макс. корисне навантаження:</strong> 150,000 кг (330,693 фунтів)</li>
                <li><strong>Ємність паливних баків:</strong> 230,000 л (60,793 галонів США)</li>
              </ul>
            </div>
            ...
            <div className="spec-card card">
              ...
              <ul>
                <li><strong>Крейсерська швидкість:</strong> 865 км/год (537 миль/год)</li>
                <li><strong>Макс. швидкість:</strong> 890 км/год (553 миль/год)</li>
                <li><strong>Дальність:</strong> 5,400 км (3,356 миль) з макс. навантаженням</li>
                <li><strong>Практична стеля:</strong> 12,000 м (39,370 футів)</li>
              </ul>
            </div>
            ...
            <div className="spec-card card">
              ...
              <ul>
                ...
                <li><strong>Загальна тяга:</strong> 918 кН (206,360 фунт-сил)</li>
              </ul>
            </div>
          </div>
        </div>
          ...
          <div className="history-content">
            ...
            <div className="timeline">
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  <h3>Перший політ</h3>
                  <p>АН-124 здійснив свій перший політ 26 грудня 1982 року, підтвердивши революційні концепції конструкції.</p>
                </div>
              </div>
