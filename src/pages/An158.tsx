        ...
        <div className="container">
          <div className="aircraft-hero-content">
            ...
            <div className="aircraft-hero-image">
              <img src={an158Image} alt="Антонов АН-158" className="hero-aircraft-img" />
            </div>
          </div>
        </div>
      </section>
          ...
          <div className="history-content">
            ...
            <div className="timeline">
              ...
              <div className="timeline-item">
                ...
                <div className="timeline-content">
                  <h3>Відновлення виробництва</h3>
                  <p>Керівництвом ДП «Антонов» заявлено про відновлення виробництва Ан-158.</p>
                </div>
              </div>
            </div>
          </div>
        ...
        <div className="container">
          <div className="overview-content">
            ...
            <ul style={{marginTop: '1rem', paddingLeft: '2rem'}}>
              ...
              <li><strong>VIP конфігурація:</strong> виконавчий транспорт зі зменшеною кількістю місць, але значно підвищеним рівнем комфорту.</li>
            </ul>
          </div>
        </div>
      </section>
      ...
      <section className="page-navigation">
        <div className="container">
          <div className="nav-links">
            <Link to="/an-178" className="btn btn-secondary" onClick={handleNavigationClick}>← Попередній: АН-178</Link>
            <Link to="/" className="btn" onClick={handleNavigationClick}>Назад до головної →</Link>
          </div>
        </div>
      </section>
    </div>
